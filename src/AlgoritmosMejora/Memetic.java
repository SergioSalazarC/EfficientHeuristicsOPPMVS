...
public class Memetic {
    ...
    public Memetic(int[] volumenPoblacion, Constructor[] constructivos, Instancia instancia, Discretization discretizacion, LocalSearch busquedaLocal, Cruce cruce, Mutacion mutacion, int tamMutacion, boolean heuristicEvaluation) throws GRBException {
    ...
    public void newGen(double ratioCross, double ratioMut, double ratioLS, boolean heuristicEvaluation) throws GRBException {
        ...
        for (int i = indexCross; i < indexMut; i++) {
            evaluations++;
            candidatos.add(mutacion.mutate(poblacion[i], discretizacion,volumenMutacion,heuristicEvaluation));
        }
